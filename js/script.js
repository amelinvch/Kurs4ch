...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /*
        <div class="work">
            <div class="photos">
                <img src="jpg/cats_sample_photo.jpeg" alt="sample photo">
            </div>
            <div class="work_content">
                <div class="work_category">Категория: животные</div>
                <div class="work_title">Кошечки &#9825;
                    <div class="work_price">200$</div>
                    <div class="work_btn_like">
                        ...
                        <div class="work_counter_like">
                            Like:
                            <span class="like_btn_counter">0</span>
                        </div>
                    </div>
    ...
    */
    ...
    for (const post of posts) {
        ...
        workButtonLike.innerHTML = `
            ...
            <div class="work_counter_like">
                Like:
                <span class="like_btn_counter">${post.countLike}</span>
            </div>
        `;

        // const textLikeBtn = document.createElement('div');
        // textLikeBtn.className = "like_btn_counter";
        // textLikeBtn.textContent = `Like: ${post.countLike}`;

        // workButtonLike.append(textLikeBtn);

        workTitle.append(workPrice);
        workTitle.append(workButtonLike);
